                                ...
                                <form action="{{ route('prosesmahasiswa', $mahasiswa->id_mhs) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="tempat_lahir_mhs" class="form-control" id="tempat_lahir_mhs"
                                               value="{{ $mahasiswa->tempat_lahir_mhs }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            value="{{ $mahasiswa->tanggal_lahir_mhs }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="jk_mhs">
                                                <option value="{{ $mahasiswa->jk_mhs }}">{{ $mahasiswa->jk_mhs }}</option>
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <select class="form-control sl2" name="id_kelas">
                                               @foreach ($kelas as $kls )
                                                   ...
                                                   <option value="{{ $kls->id_kelas }}" {{ $mahasiswa->id_kelas == $kls->id_kelas ? "selected" : "" }}>{{ $kls->nama_kelas }}</option>
                                               @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <img src="{{ asset('gambar').'/'.$mahasiswa->foto_mhs }}" alt="" style="width: 50px">
